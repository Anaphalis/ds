...
IM._assign = function (o1,o2){
  if(typeof o1 !== 'object'||o1===null||typeof o2 !== 'object'||o2===null)return console.error('参数错误');
...
IM.modify = function modify (o1,op){
  if(typeof o1 !== 'object'||o1===null)console.error('参数错误');
  var ret = IM(o1);
  if(!op)return ret;
  if(op.hasOwnProperty('upsert')&&isRawObject(op.upsert)){
    //添加&修改
    Object.keys(op.upsert).forEach((key) => {
